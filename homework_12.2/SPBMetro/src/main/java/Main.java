...
public class Main {
    ...
    private static final Marker NOT_FOUND_MARKER = MarkerManager.getMarker("NotFound");


    private static final String DATA_FILE = "/Users/alekseydarakchan/Desktop/Skillbox/java_basics/12_ExceptionsDebuggingAndTesting/homework_12.2/SPBMetro/src/main/resources/map.json";
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            logger.info(SEARCH_MARKER, "Поиск станций: " + line);
